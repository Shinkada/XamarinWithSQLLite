...
using XamarinWithSQLLite.iOS.Data;

[assembly: Dependency(typeof(NetworkConnection))]
namespace XamarinWithSQLLite.iOS.Data {
    public class NetworkConnection : INetworkConnection {
        ...
        public bool IsNetworkAvailable(out NetworkReachabilityFlags flags) {
            ...
            return IsReachabableWithoutRequiringConnection(flags);
        }

        private bool IsReachabableWithoutRequiringConnection(NetworkReachabilityFlags flags) {
